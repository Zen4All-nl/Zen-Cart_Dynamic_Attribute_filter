...
VALUES ('Dynamic Filter', 'Dynamic Filter Settings', '1', '1');
...
VALUES ('Enable on Category Pages', 'FILTER_CATEGORY', 'Yes', 'Enable the filter on category pages?', @cid, '10', now(), now(), NULL, "zen_cfg_select_option(array('Yes', 'No'),"),
  ...
  ('Enable Price filter', 'SHOW_FILTER_BY_PRICE', 'Yes', 'Enable the price filter?', @cid, '105', now(), now(), NULL, "zen_cfg_select_option(array('Yes', 'No'),"),
  ...
  ('Enable products left', 'FILTER_OPTIONS_LEFT', 'Yes', 'Do you want to show the number of products left to be filtered to show?', @cid, '65', now(), now(), NULL, "zen_cfg_select_option(array('Yes', 'No'),");
...
VALUES ('configDynamicFilter', 'BOX_CONFIGURATION_DYNAMIC_FILTER', 'FILENAME_CONFIGURATION', CONCAT('gID=', @cid), 'configuration', 'Y', @cid);