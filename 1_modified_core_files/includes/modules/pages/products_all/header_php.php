...
// bof dynamic filter 1 of 1
  ...
  $products_all_query_raw = "SELECT DISTINCT p.products_type, p.products_id, pd.products_name, p.products_image, p.products_price, p.products_tax_class_id,
                             ...
                             AND (p.products_date_available IS NULL
                               OR p.products_date_available <= current_date)
  ...
  $listing_sql = $db->bindVars($products_all_query_raw, ':languageID', $_SESSION['languages_id'], 'integer');
